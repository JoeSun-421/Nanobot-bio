...
def normalize_verdict(
    ...
    *,
    ...
    caveat_keys = (
        ...
        "literature_function_axis",
        "literature_pmc_off_topic",
        "literature_lit_only_peers",
        "literature_lit_only_dropped",
        "literature_lit_only_recompare",
        "literature_peer_decisions",
        "fusion_weights_override",
        "fusion_weights_clamped",
        "mmseqs_segfall",
        "low_head_coverage",
