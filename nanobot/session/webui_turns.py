"""Quarantined vendored WebUI compatibility helpers.

The nanobot-bio product is terminal-only and does not import this module from
its scientific path. It remains intact solely for upstream compatibility while
awaiting explicit deletion approval; see ``docs/SLIMMING_CANDIDATES.md``.
"""
