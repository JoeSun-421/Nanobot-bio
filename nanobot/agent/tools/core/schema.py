"""JSON Schema fragment types: all subclass :class:`~nanobot.agent.tools.core.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~nanobot.agent.tools.core.base.Schema.validate_json_schema_value` /
  :class:`~nanobot.agent.tools.core.base.Tool`.
...
from nanobot.agent.tools.core.base import Schema
