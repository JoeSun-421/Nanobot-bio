...
from nanobot.agent.tools.core.context import current_request_session_key
from nanobot.agent.tools.core.schema import (
    BooleanSchema,
    IntegerSchema,
    StringSchema,
...
class ExecSessionManager:
    ...
    async def _spawn(
        ...
        from nanobot.agent.tools.legacy.shell import ExecTool
...
class WriteStdinTool(Tool):
    ...
    @classmethod
    def config_cls(cls):
        from nanobot.agent.tools.legacy.shell import ExecToolConfig
