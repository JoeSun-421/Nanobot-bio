...
class AgentRunner:
    ...
    async def _run_tool(
        ...
        try:
            ...
            # Scientific stage scheduling: successful/soft-failed retrieve calls
    ...
    def _partition_tool_batches(
        ...
        prerequisite_tools: set[str] = set()
        with suppress(Exception):
            from nanobot.agent.tools.rbp.stage_contract import REQUIRES
