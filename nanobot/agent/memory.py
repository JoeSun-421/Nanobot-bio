...
class MemoryStore:
    ...
    def build_dream_tools(self):
        ...
        from nanobot.agent.skills import BUILTIN_SKILLS_DIR
        from nanobot.agent.tools.legacy.apply_patch import ApplyPatchTool
        from nanobot.agent.tools.legacy.file_state import FileStates
        from nanobot.agent.tools.legacy.filesystem import EditFileTool, ReadFileTool, WriteFileTool
